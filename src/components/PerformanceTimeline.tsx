...
const PerformanceTimeline = () => {
  return (
    <section id="performances" className="py-24 px-4 bg-secondary/50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-primary/30 hidden md:block" />
          ...
          <div className="space-y-12">
            {performances.map((event, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-6 h-6 rounded-full bg-primary border-4 border-background z-10 hidden md:block">
                  {event.highlight && (
                ...
                {/* Content Card */}
                <div
                  className={`ml-20 md:ml-0 bg-card border ${
                    event.highlight ? "border-primary border-2" : "border-primary/30"
                  } rounded-lg p-6 hover-lift group ${
