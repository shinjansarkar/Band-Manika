        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-slide-in">
            ...
            <div className="flex gap-4 pt-4">
              <div className="flex-1 p-6 bg-card border border-primary/30 rounded-lg hover-lift">
                <h3 className="text-3xl font-display font-bold text-primary mb-2">50+</h3>
                <p className="text-sm text-foreground/70">Performances</p>
              </div>
              <div className="flex-1 p-6 bg-card border border-primary/30 rounded-lg hover-lift">
                <h3 className="text-3xl font-display font-bold text-primary mb-2">10+</h3>
                <p className="text-sm text-foreground/70">Years Together</p>
              </div>
              <div className="flex-1 p-6 bg-card border border-primary/30 rounded-lg hover-lift">
                <h3 className="text-3xl font-display font-bold text-primary mb-2">1000+</h3>
                <p className="text-sm text-foreground/70">Hearts Touched</p>
              </div>
            </div>
          </div>
